...
int main(void)
{
    ...
    static int particleRenderSize = 16.0f;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        view = camera.GetViewMatrix();
        billboard_shader.setFloat("BILLBOARD_SIZE", particleRenderSize);
        ...
        if (ImGui::CollapsingHeader("Render Parameters")) {
            ...
            ImGui::SliderInt("Particle Render Size", &particleRenderSize, 1, 100);
        ...
        if (ImGui::CollapsingHeader("Simulation Parameters")) {
            ...
            ImGui::SliderInt("Particle Count Multiplier", &particleCountMult, 1, 100);
